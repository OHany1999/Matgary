...
import 'package:matgary/carts/general%20_cart_apis/2-update_cart/data/model/update_cart_model.dart';
...
abstract class BaseUpdateCartRemoteDataSource {
  Future<UpdateCartModel> getUpdateCartData(UpdateCartParameters parameters);
}

class UpdateCartRemoteDataSource extends BaseUpdateCartRemoteDataSource {
  @override
  Future<UpdateCartModel> getUpdateCartData(
